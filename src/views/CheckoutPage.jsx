            ...
            <fieldset className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <DeliveryOption
                  ...
                  body="Free · pick up from our Old Bodija store"
                  selected={isPickup}
            ...
            {!isPickup ? (
              <fieldset className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <Field label="City" name="city" autoComplete="address-level2" value={formData.city} onChange={handleFieldChange} />
                  <Field label="State" name="state" required autoComplete="address-level1" value={formData.state} onChange={handleFieldChange} />
                  <Field label="Postal code" name="postal" autoComplete="postal-code" value={formData.postal} onChange={handleFieldChange} />
                ...
                <div className="rounded-xl border border-brand-blue/30 bg-brand-blue-soft/40 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      <div className="font-semibold text-slate-900">Speedtouch — Old Bodija</div>
